!(function() {
    ...
    var T = c(function(e) {
        ...
        O = c(function(e) {
            for (
                var n = e.replace(/^\//, "").split("/"), i = [], o = 0, t = n.length; o < t; o++
            ) {
                var a = n[o];
                ".." === a ? i.pop() : "." !== a && i.push(a);
            }
                    ...
                    void 0 === i && (i = d),
                        p("click", function(e) {
                            ...
                            n &&
                                ...
                                (e.preventDefault(),
                                    (n = n.href), -1 !== o.config.crossOriginLinks.indexOf(n) ?
                                    window.open(n, "_self") :
    ...
    function ue(e) {
        ...
        return (!0 === i.loadSidebar && (i.loadSidebar = "_sidebar" + i.ext), !0 === i.loadNavbar && (i.loadNavbar = "_navbar" + i.ext), !0 === i.coverpage && (i.coverpage = "_coverpage" + i.ext), !0 === i.repo && (i.repo = ""), !0 === i.name && (i.name = ""),
            (window.$docsify = i)
        );
    }
    var fe = {},
                    ...
                    if (n) {
                        ...
                        return (
                            ...
                            ((e = Xe(i, "#")),
                                ...
                                (i = e.trim())), { type: "heading", raw: n[0], depth: n[1].length, text: i }
                        );
                    }
                }),
                ...
                (e.prototype.tag = function(e, n, i) {
                    ...
                    if (e)
                        return (!n && /^<a /i.test(e[0]) ?
                            (n = !0) :
                            n && /^<\/a>/i.test(e[0]) && (n = !1), !i && /^<(pre|code|kbd|script)(\s|>)/i.test(e[0]) ?
                            (i = !0) :
                            i &&
                ...
                (e.prototype.codespan = function(e) {
                    ...
                    if (n) {
                        ...
                        return (
                            ...
                            (i = Je(i, !0)), { type: "codespan", raw: n[0], text: i }
                        );
                    }
                }),
            ...
            return (
                ...
                (i.prototype.blockTokens = function(e, n, i) {
                    ...
                    for (
                        ...
                        for (
                            e = e.substring(o.raw.length), a = o.items.length, t = 0; t < a; t++
                        )
                        ...
                        switch ((a = e[c]).type) {
                            ...
                            case "table":
                                ...
                                for (o = a.cells.length, n = 0; n < o; n++)
                                    for (
                                        t = a.cells[n], a.tokens.cells[n] = [], i = 0; i < t.length; i++
                                    )
                                        (a.tokens.cells[n][i] = []),
                ...
                (i.prototype.parse = function(e, n) {
                    ...
                    for (
                        ...
                        switch ((f = e[b]).type) {
                            ...
                            case "table":
                                for (c = p = "", t = f.header.length, i = 0; i < t; i++)
                                    c += this.renderer.tablecell(
                                        this.parseInline(f.tokens.header[i]), { header: !0, align: f.align[i] }
                                    );
                                for (
                                    ...
                                    for (
                                        c = "", a = (r = f.tokens.cells[i]).length, o = 0; o < a; o++
                                    )
                            ...
                            case "text":
                                for (
                                    u = f.tokens ? this.parseInline(f.tokens) : f.text; b + 1 < m && "text" === e[b + 1].type;
    ...
    function An(e, i) {
        if (
            (void 0 === i && (i = '<ul class="app-sub-sidebar">{inner}</ul>'), !e || !e.length)
        )
            return "";
        var o = "";
        return (
                            ...
                            highlightElement: function(e, n, i) {
                                ...
                                if (
                                    (T.hooks.run("before-sanity-check", r),
                                        ...
                                        a.setAttribute("tabindex", "0"), !r.code)
                                )
                                    return (
                                        ...
                                        for (var c in o)
                                            if (o.hasOwnProperty(c) && o[c]) {
                                                ...
                                                for (var f = 0; f < u.length; ++f) {
                                                    ...
                                                    for (
                                                        var h = d.pattern || d, _ = t.next, m = a; _ !== i.tail && !(r && m >= r.reach); m += _.value.length, _ = _.next
                                                    ) {
                                                        var b = _.value;
                                                        ...
                                                        if (!(b instanceof C)) {
                                                            ...
                                                            if (l) {
                                                                ...
                                                                for (
                                                                    var A = _; A !== i.tail &&
                                                                    (S < x || "string" == typeof A.value); A = A.next
                                                                )
                                                                    w++, (S += A.value.length);
    ...
    function Gn(e) {
        ...
        if (((e = e || "<h1>404 - Not found</h1>"), "Vue" in window))
            for (
                var a = 0, r = k(".markdown-section > *").filter(n); a < r.length; a += 1
            ) {
                var c = r[a];
                                    ...
                                    !(function(e) {
                                        ...
                                        for (
                                            var i,
                                                ...
                                                o = [],
                                                t = 0,
                                                a = (o = null != n ? k(n, "li") : o).length; t < a; t += 1
                                        ) {
                                            var r,
                                                c,
                                                u = o[t],
                                ...
                                (n.prototype.initRender = function() {
                                    ...
                                    u
                                        ...
                                        (v.head.appendChild(
                                            ...
                                            ((e = k("style:not(.inserted),link")), [].forEach.call(e, function(e) {
                                                "STYLE" === e.nodeName ?
                                                    Q(e, a) :
                                                    "LINK" === e.nodeName &&
