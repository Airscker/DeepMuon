...
LastEditTime: 2022-10-28 22:45:20
...
'''
work_config=dict(work_dir='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/CSPP_6',logfile='log.log')
'''
...
checkpoint_config=dict(load_from='',resume_from='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/CSPP_6/Best_Performance.pth',save_inter=500)
...
'''
hyperpara=dict(epochs=5000,batch_size=12000,inputshape=[1,3,10,10,40])
'''
