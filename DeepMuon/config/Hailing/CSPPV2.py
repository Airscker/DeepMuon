...
LastEditTime: 2022-12-27 18:06:16
...
'''
model = dict(filepath='./DeepMuon/models/CSPP.py',
             backbone='CSPP', params=dict())
'''
## Specify the dataset to load the data, all dataset are stored in 'dataset'
'''
train_dataset = dict(filepath='', backbone='HailingDataset_Direct2', params=dict(
    datapath='/home/dachuang2022/Yufeng/Hailing-Muon/data/1TeV/1Tev_Resample_4Sigma45_train60k.pkl'))
test_dataset = dict(filepath='', backbone='HailingDataset_Direct2', params=dict(
    datapath='/home/dachuang2022/Yufeng/Hailing-Muon/data/1TeV/1Tev_Resample_4Sigma45_test20k.pkl'))
'''
## Specify the work_dir to save the training log and checkpoints
'''
work_config = dict(
    work_dir='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/CSPP_5', logfile='log.log')
'''
...
checkpoint_config = dict(
    load_from='', resume_from='/home/dachuang2022/Yufeng/Hailing-Muon/work_dir/1TeV/CSPP_5/Best_Performance.pth', save_inter=500)
