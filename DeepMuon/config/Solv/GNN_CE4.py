...
LastEditTime: 2023-11-05 15:53:44
Description: NULLs
...
model = dict(backbone='SolvGNNV7',pipeline='solvgnn',params=dict(in_dim=74, hidden_dim=1024, add_dim=6, mlp_dims=[1024,512], gcr_layers=10 ,n_classes=1,allow_zero_in_degree=True))

train_dataset = dict(backbone='MultiSmilesGraphData',collate_fn='collate_ce',
                     params=dict(pred_ce=True,
...
work_config = dict(work_dir='/home/yufeng/workdir/MINES/CE_DS/GNNV7M001')
