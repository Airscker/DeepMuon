...
LastEditTime: 2023-05-29 20:13:51
Description: NULLs
...
train_dataset = dict(backbone='SmilesGraphData',collate_fn='collate_solubility',
                     params=dict(information_file='E:\OneDrive\OneDrive - USTC\StonyBrook\Computational Materials\SolvGNN\MINES\data\comp_data.csv',
                                 solubility_file='E:\OneDrive\OneDrive - USTC\StonyBrook\Computational Materials\SolvGNN\MINES\data\cnn_data.csv',end=700))
test_dataset = dict(backbone='SmilesGraphData',collate_fn='collate_solubility',
                    params=dict(information_file='E:\OneDrive\OneDrive - USTC\StonyBrook\Computational Materials\SolvGNN\MINES\data\comp_data.csv',
                                 solubility_file='E:\OneDrive\OneDrive - USTC\StonyBrook\Computational Materials\SolvGNN\MINES\data\cnn_data.csv',start=700))

work_config = dict(work_dir='../Hailing-Muon/MINES/GNN005')
...
hyperpara = dict(epochs=600, batch_size=64)
