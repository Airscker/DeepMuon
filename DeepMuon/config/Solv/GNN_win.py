...
LastEditTime: 2023-09-03 03:01:43
Description: NULLs
...
model = dict(backbone='SolvGNNV3',pipeline='solvgnn',params=dict(in_dim=74, hidden_dim=1024, gcr_layers=5,n_classes=1,allow_zero_in_degree=True))
...
work_config = dict(work_dir='/home/yufeng/workdir/MINES/CO2_SOLV/debug')
...
hyperpara = dict(epochs=10, batch_size=128)
