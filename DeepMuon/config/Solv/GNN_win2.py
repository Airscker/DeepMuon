...
LastEditTime: 2023-09-20 20:05:09
Description: NULLs
...
model = dict(backbone='SolvGNNV5',pipeline='solvgnn',params=dict(in_dim=74, hidden_dim=1024, add_dim=2, mlp_dims=[1024,512], gcr_layers=2 ,n_classes=1,allow_zero_in_degree=True))
...
work_config = dict(work_dir='/home/yufeng/workdir/MINES/CO2_SOLV/GNNV5M001')
